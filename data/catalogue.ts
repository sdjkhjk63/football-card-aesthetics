...
const inceptionUccCardDesigns: CardDesign[] = [
  ...
  inceptionCard({ slug: "club-crest-autograph-patch-v1", officialName: "Club Crest Autograph Patch — Erling Haaland Version 1", zh: "俱乐部徽章签字切片·哈兰德版本 1", es: "Parche autografiado de escudo · Haaland Versión 1", serial: "1/1", displayParallelName: "CCA-EH1 · Version 1", parallels: [{ name: "CCA-EH1 · Version 1", serial: "1/1" }] }),
  inceptionCard({ slug: "club-crest-autograph-patch-v2", officialName: "Club Crest Autograph Patch — Erling Haaland Version 2", zh: "俱乐部徽章签字切片·哈兰德版本 2", es: "Parche autografiado de escudo · Haaland Versión 2", serial: "1/1", displayParallelName: "CCA-EH2 · Version 2", parallels: [{ name: "CCA-EH2 · Version 2", serial: "1/1" }] }),
